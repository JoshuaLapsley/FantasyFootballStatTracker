  ...
  return (
    <div className="player-page">
      ...
      <header className="punishment-header">
        <h1 className="punishment-title">Vegan For a Month</h1>
      ...
      <section className="punishment-story">
        <p>
          ...
          Eventually it was put to a vote, and the punishment was selected was going Vegan for a month.
        </p>
        <p>
        ...
        <p>
          ...
          choose the vegan option that night. He didn't tell anyone about it, but SupernovaMa sent Supernova a text saying that he did in fact not eat meat.
        </p>
      </section>
